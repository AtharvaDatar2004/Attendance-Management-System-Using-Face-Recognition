    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='atharva1', db='manually_fill_attendance')
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='atharva1', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                cs = 'C:/Users/shris/OneDrive/Desktop/Attendance project/StudentDetails/' + fileName
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                root.configure(background='grey80')
                fileName = "StudentDetails.csv"
                cs = 'C:/Users/shris/OneDrive/Desktop/Attendance project/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
